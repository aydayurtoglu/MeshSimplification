...
void keyboard (unsigned char key, int x, int y)
{
    ...
    case 'A':
        cout << "Enter the filename you want to open:";
        cin >> filename;
        myObj.readFileTypeSTL(filename);
        break;
    case 'F':
        myObj.fnextList();
        break;
    case 'J':
        ...
        break;
    case '1': cout << "Computing vertex normals for smooth shading" << endl;
            myObj.computeVertexNormals(); break;
    case '2': cout << "Visualizing edges" << endl;
            myObj.edges = !myObj.edges; break;
    case '3':
    case '4':
        current_object = key - '1';
        break;
    case ' ':
        cout << "Simplifying mesh" << endl;
        double percentage;
        cout << "Enter percentage: ";
        cin >> percentage;
        myObj.simplifyMesh(percentage);
        break;
    case 'Q':
    case 'q':
        exit(0);
